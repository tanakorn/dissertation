...
\newcommand{\csb}[1]{\jira{CASSANDRA}{CA}{#1}}
\newcommand{\zk}[1]{\jira{ZOOKEEPER}{ZooKeeper}{#1}}
\newcommand{\mr}[1]{\jira{MAPREDUCE}{MapReduce}{#1}}
\newcommand{\cs}[1]{\jira{CASSANDRA}{Cassandra}{#1}}
