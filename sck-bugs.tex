...
%the
%namenode must process a block report for 0.14sec for every 2 seconds;
%thus, 7\% of the time the namenode cannot serve users.


% see OLD-FIles/eval-bugs for complete HDFS 
...
% \hsg{we have reproduced X out of 40 bugs that we studied (due to time
%   limitation).  however, we believe that all other patterns are detectable
%  too}
