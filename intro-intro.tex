...
%but there still have been many cloud outages reported
%\cite{Blodget11-BussInAmazonDestroyCustomers, Miller12-DCKAmazonKOs,
%Google10-AppEnginePostMortemFeb, Google10-DatastoreOutageMay,
%Gmail09-MoreOnTodayIssue, Skype10-PostMortemOutage,
%PayPal10-DetailsOnSiteOutage}. Fascinated by these outage reports, we want to
