...
\end{center}
\vminten
\mycaption[Reproduced bugs]{tab-bugs}{Reproduced bugs}{``Surface'' implies the
number of nodes needed for the bug symptom to surface.  ``c'' stands for
Cassandra, ``r'' for Riak, and ``v'' for Voldemort.  }
\vminfive
\end{table}
